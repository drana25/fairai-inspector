...
export default function Login({ user }) {
  ...
  return (
    <div className="login-page min-h-screen flex items-center justify-center relative overflow-hidden text-white">
      ...
      <button 
        onClick={() => navigate('/')}
        className="absolute top-6 left-6 z-20 flex items-center gap-2 text-gray-400 hover:text-white transition-colors text-sm font-medium bg-[#12121a]/50 px-4 py-2 rounded-full border border-white/5 hover:border-white/20 backdrop-blur-md"
      >
      ...
      >
        ...
        <button 
           ...
           className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-white text-black font-medium hover:scale-105 transition mb-3"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-indigo-400/30 text-indigo-400 hover:bg-indigo-500/10 transition"
        >
        ...
        <div className="mt-4 flex flex-col items-center gap-2">
          <div className="text-xs w-full bg-pink-500/10 border border-pink-400/20 rounded-full px-3 py-1.5 text-pink-400 flex items-center justify-center gap-2">
            <span>🎯</span> SDG 10 — Reduced Inequalities
          </div>
          <div className="text-xs w-full bg-blue-500/10 border border-blue-400/20 rounded-full px-3 py-1.5 text-blue-400 flex items-center justify-center gap-2">
            <span>⚖️</span> SDG 16 — Justice
          </div>
        </div>
      </motion.div>
    </div>
